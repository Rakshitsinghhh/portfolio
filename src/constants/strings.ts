class Strings {
  ...
  static buyMeACoffeeUsername = "rakshitsinghhh";

  static koFi = "Ko-Fi";
  static koFiLink = "https://ko-fi.com/rakshitsinghhh";
  static koFiUsername = "rakshitsinghhh";

  static fullName = "Rakshit singh";
  static shortName = "rakshitsinghhh";
}
